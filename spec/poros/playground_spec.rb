...
RSpec.describe Playground do
  describe "initialize" do
    it 'exists' do
      data = {formatted_address: "450 Powers St, Erie, CO 80516, United States", name: "Lehigh Park", place_id: "ChIJkTXfW-z1a4cRzrN-7OsfDNY", rating: 4.6}
      image_data = 'image_url'
      playground = Playground.new(data, image_data)
